...
Applied advanced statistical techniques, including PCA, k-means clustering, SVMs, and Kernel PCA using **Python**, **R**, and **scikit-learn** on datasets like MNIST to perform tasks such as dimensionality reduction, clustering, and classification.
